...
- **LLM Provider**: Set `LLM_PROVIDER` to either `litellm` or `azure`
- **Azure OpenAI**: Get endpoint, API key, API version, and deployment name from your Azure portal
- **LiteLLM**: Configure your LiteLLM API credentials if using the LiteLLM provider
